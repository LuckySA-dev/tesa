...
class SubmissionValidator:
    ...
    def match_detections(self, pred_df, gt_df):
        ...
        print(f"   ❌ Unmatched predictions: {unmatched_pred}")
        print(f"   ❌ Unmatched ground truth: {unmatched_gt}")
    ...
    def calculate_mae(self, matched_df):
        ...
        if len(matched_df) == 0:
            print("   ⚠️ No matched detections to calculate MAE")
            return {}
    ...
    def validate(self, predictions_path, ground_truth_path):
        ...
        """
        print("="*70)
        print("🔍 TESA DEFENCE - SUBMISSION VALIDATION")
        print("="*70)
