...
def convert_to_problem2_format(input_csv, output_csv):
    ...
    print(f"📐 Calculating height from elevation angle...")
...
def convert_with_tracking(detection_csv, prediction_csv, output_csv):
    ...
    """
    print(f"📥 Loading detection tracking: {detection_csv}")
    det_df = pd.read_csv(detection_csv)
    
    print(f"📥 Loading predictions: {prediction_csv}")
...
if __name__ == '__main__':
    ...
    print("="*70)
    print("🔧 PROBLEM 2 FORMAT CONVERTER")
    print("="*70)
    print("Conversion:")
    print("  • azimuth_deg → direction (0-360°)")
    print("  • range_m → distance (m)")
    print("  • elevation_deg + distance → height (m)")
    print("="*70)
