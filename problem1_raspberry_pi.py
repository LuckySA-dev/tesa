...
class RaspberryPiOptimizer:
    ...
    def apply_optimizations(self):
        ...
        if self.is_pi:
            ...
            print("   ℹ️  Not Raspberry Pi, using default settings")
...
class RaspberryPiDroneDetector:
    ...
    def __init__(
        ...
        if self.verbose:
            print("\n" + "="*70)
            print("🥧 RASPBERRY PI 5 OPTIMIZED DRONE DETECTION")
            print("="*70)
    ...
    def process_video(
        ...
        print("\n" + "="*60)
        print("⏳ Processing... (This may take a while on Pi)")
        print("="*60)
    ...
    def _monitor_system(self, frame_id, total_frames, start_time):
        ...
        if metrics['temperature']:
            ...
            if temp > 70:
                print(" ⚠️  HIGH!")
                if temp > 80:
                    print("   ⚠️  WARNING: Thermal throttling likely!")
        ...
        if self.detections:
            ...
            if self.stats['temperatures']:
                ...
                if max_temp > 70:
                    ...
                    print(f"   💡 Consider adding cooling solution")
                
                if self.stats['throttle_warnings'] > 0:
                    print(f"   ⚠️  Throttle warnings: {self.stats['throttle_warnings']}")
...
def main():
    ...
    if machine not in ['aarch64', 'armv7l', 'armv8', 'AMD64']:
        print(f"⚠️  Warning: Not ARM architecture (detected: {machine})")
