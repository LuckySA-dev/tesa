...
class RegressionPipeline:
    ...
    def predict_batch(self, detections_df, img_width=None, img_height=None):
        ...
        """
        print(f"🔮 Predicting for {len(detections_df)} detections...")
        ...
        if img_width is None or img_height is None:
            ...
            if 'img_width' in detections_df.columns and 'img_height' in detections_df.columns:
                ...
                img_width = 2048
                img_height = 1364
                print(f"   ⚠️  Using default dimensions: {img_width}x{img_height}")
                print(f"   ⚠️  For accurate results, provide img_width and img_height parameters!")
        else:
...
if __name__ == '__main__':
    ...
    print("="*70)
    print("🔮 PROBLEM 2: REGRESSION INFERENCE")
    print("="*70)
    ...
    if args.video and (args.width is None or args.height is None):
        ...
        cap.release()
        print(f"📹 Auto-detected dimensions from video: {args.width}x{args.height}")
